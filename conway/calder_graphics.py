...
class GraphWin(tk.Canvas):
    ...
    def __init__(self, title="Graphics Window",
        ...
        master = tk.Toplevel(calder_root)
        ...
        master.lift()
        self.lastKey = ""
        if autoflush: calder_root.update()
...
class Entry(GraphicsObject):
    ...
    def __init__(self, p, width):
        ...
        #print self.anchor
        self.width = width
        self.text = tk.StringVar(calder_root)
        self.text.set("")
        self.fill = "gray"
        self.color = "black"
...
class Image(GraphicsObject):
    ...
    def __init__(self, p, *pixmap):
        ...
        if len(pixmap) == 1: # file name provided
            self.img = tk.PhotoImage(file=pixmap[0], master=calder_root)
        else: # width and height provided
            width, height = pixmap
            self.img = tk.PhotoImage(master=calder_root, width=width, height=height)
...
#MacOS fix 2
#tk.Toplevel(calder_root).destroy()
